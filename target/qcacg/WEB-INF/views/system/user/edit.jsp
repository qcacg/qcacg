	...
	<div class="ibox-content">
		<form class="form-horizontal m-t required-validate" id="userForm">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="accountName" name="accountName"  class="form-control" type="text" value="${user.telephone}"
			...
			<div id="selGroup"
				data-url="/role/selRole.shtml?userId=${user.userId}"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="tel" name="tel"  class="form-control" type="tel" value="${user.information}"
						validate="{required:true,messages:{required:'个人简介'}}">
						<span class="help-block m-b-none">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="radio i-checks">
                      	...
                      	<label><input type="radio" value="1" ${user.userStatus == 1 ? 'checked="checked" ' : null} name="locked"> <i></i> 启用</label>
                    </div>
				</div>
			</div>
		</form>
