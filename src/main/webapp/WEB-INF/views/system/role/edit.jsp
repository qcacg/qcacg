	...
	<div class="ibox-content">
		<form class="form-horizontal m-t required-validate" id="roleForm">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="description" name="description"  class="form-control" type="text" value="${role.roleDescription}">
						<span class="help-block m-b-none">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="radio i-checks">
                      	...
                      	<label><input type="radio" value="1" ${role.roleStatus == 1 ? 'checked="checked" ' : null} name="isEnabled"> <i></i> 启用</label>
                    </div>
				</div>
			</div>
		</form>
