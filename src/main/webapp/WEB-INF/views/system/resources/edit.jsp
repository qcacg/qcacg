...
<div class="ibox float-e-margins">
	<div class="ibox-content">
		<form class="form-horizontal m-t required-validate" id="resourcesForm">
			<input type="hidden" name="id" value="${resources.resourcesId}"/>
			<div class="form-group">
				<label class="col-sm-3 control-label">资源名称：</label>
				<div class="col-sm-8">
					<input  type="text" class="form-control" 
						placeholder="请填写资源名称"  value="${resources.resourcesName}" id="name" name="name"
				...
				<div class="col-sm-8">
					<select id="parentId" name="parentId" class="form-control m-b" tabindex="-1">
						...
						<c:forEach items="${list}" var="k">
							<option value="${k.resourcesId}" <c:if test="${resources.parentResourcesId == k.resourcesId}">selected="selected"</c:if>>
								<c:forEach begin="1" end="${k.resourcesOrder == 0  ?  3 : k.resourcesOrder * 3 + 3 }"> -</c:forEach> + ${k.resourcesName}
							</option>
						</c:forEach>
					</select>
					<span class="help-block m-b-none">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control"
						placeholder="请填写资源地址" name="resUrl" id="resUrl"  value="${resources.resourcesUrl}">
						<span class="help-block m-b-none">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control checkacc"
						placeholder="请输入icon" name="icon" id="icon" value="${resources.resourcesView}">
						<span class="help-block m-b-none">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control"
						placeholder="请输入资源描述" name="description" id="description"  value="${resources.resourcesDescription}">
						<span class="help-block m-b-none">
				</div>
			</div>
		</form>
...
var v = $("#type").val(CommnUtil.notNull("${resources.resourcesType}") ? "${resources.resourcesType}" : 0);
