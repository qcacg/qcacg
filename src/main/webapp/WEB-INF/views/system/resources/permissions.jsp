...
<table id="mytable" cellspacing="0" summary="The technical specifications of the Apple PowerMac G5 series">
 <tr>
  ...
  <tr>
    ...
    <input type="checkbox" name="resId" id="menu" _key="menu_${k.resourcesId}" onclick="smenu(this,'${k.resourcesId}')" value="${k.resourcesId}">
    ${k.resourcesName}
    </th>
    <th scope="row" abbr="L2 Cache" class="specalt">
    ...
    <c:forEach items="${k.childrenResources}" var="kc">
    <tr>
    <th scope="row" abbr="L2 Cache" class="specalt">
    <input type="checkbox"  name="resId" id="menu" _key="menu_1_${k.resourcesId}" _key_1="menu_1_1_${kc.resourcesId}" onclick="menu_1(this,'${kc.resourcesId}','${k.resourcesId}')"  value="${kc.resourcesId}">
    ${kc.resourcesName}
    </th>
     <th>
    <c:if test="${not empty kc.childrenResources}">
   
    <table id="mytable" cellspacing="0" summary="The technical specifications of the Apple PowerMac G5 series" style="width: 100%;height: 100%;">
    <c:forEach items="${kc.childrenResources}" var="kcc">
    <tr>
    <th scope="row" abbr="L2 Cache" class="specalt">
    <input type="checkbox"  name="resId" id="menu" _key="menu_1_1_${k.resourcesId}" _key_2="menu_1_1_${kc.resourcesId}" onclick="menu_1_1(this,'${kc.resourcesId}','${k.resourcesId}')" value="${kcc.resourcesId}">
    ${kcc.resourcesName}
    </th>
     </tr>
    </c:forEach>
