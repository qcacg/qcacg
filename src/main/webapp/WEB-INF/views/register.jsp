				...
				<div class="content">
					<div class="content_top">
						<div class="back-links">
							<p>
								<a href="index.indexx.html">Home</a> &gt;&gt;&gt;&gt;
							...
							<div class="contact-form">
								...
								<form id="regiserForm" method="post"
									...
									<div>
										...
										<span><input name="telephone" value="${userTCustom.telephone}"
												type="text" class="textbox">
										</span>
										
										<span style= "color:red" >${telephoneError }</span>
										<span style= "color:red" >${sameTelephone }</span>
									...
									<div>
										...
										<span>
											<input name="passwdConfirm" 
												value="${userTCustom.passWordConfirm }" type="text" class="textbox">
