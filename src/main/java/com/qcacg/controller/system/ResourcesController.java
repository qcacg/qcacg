...
public class ResourcesController extends BaseController
{
	...
	public String editRoleRes(String userId,String roleId, Integer[] resourcesId) throws Exception
	{
		return this.resourcesService.updateGroupByRole(userId,roleId,resourcesId);
	}
